...
**1. Do you know what are the `.bai` files?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

A bai file is an indexed form of a bam - it's a companion to your bam that contains the index.
...
**1. How do you figure out what the genotype is for each variant?**
...
**2. Do we have any annotation information yet?**
...
**4. Did we find the same number of variants using the files before and after duplicate removal and realignment?**
...
**5. Is this result concordant to our previous comparison of files before and after duplicate removal and realignment?** 

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

The real number of variants which differ is higher than what we estimated by just counting the variant number:
...
**6. Do the SNPs look believable?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

Yes most of them look believable, but sometime in region with lower coverage the call coul be more ambigous.
...
**7. Are there any positions that you think should have been called as a SNP, but weren’t?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

Probably yes but very few!
...
**9. Can you find the largest INDEL?**
...
**1. What is QD, FS, and MQ?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

By looking at INFO field we can understand the filter.
...
**1. What does the example annotation actually mean?**
...
**2. How many variants had a high impact?**
...
**3. How many variants had a moderate impact?**
...
**4. What effect categories were represented in these variants?**
...
**5. Open that position in IGV, what do you see?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

The variant 1 17944934 is a C->T substitution in the 29th codon of the exome 1 of the ARHGEF10 gene. Substitution induce a change from a Alanine to a Valine amino acid.
...
**1. What do you see in the third column?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

The 3rd which correspond to the ID of the variant is empty .. We can actually not see if variants we are look at have already been discover in other samples.
...
**2. What percentage of the variants that passed all filters were also in dbSNP?**
...
**3. Can you find a variant that passed and wasn’t in dbSNP?**
...
We can extract the HIGH impact variant in all sample using this command:
...
4. GATK produces even better variant calling results if all three BAM files are specified at the same time (i.e. specifying multiple `-I filename` options). Try this and then perform the rest of module 4 on the trio vcf file. **Does this seem to improve your variant calling results? Does it seem to reduce the trio conflict rate?**

:::: {.callout title="Solution (click here)"type="gray" style="subtle" icon="true" collapsible="true"}

Most of the variant have keep the same genotpes but it improve call in supicious site such as 1:17,841,784-17,841,823.
...
You’re done Module 4! We hope that you enjoyed the lab and that you continue to enjoy Single Nucleotide Variant Calling.
